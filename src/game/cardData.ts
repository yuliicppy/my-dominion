...
export const cardMaster: Card[] = [
  ...
  { id: 'duchy', name: '公領', types: ['Victory'], cost: 5, description: '勝利点3', effects: [], expansion: 'Base', isBasicSupply: true },
  { id: 'province', name: '属州', types: ['Victory'], cost: 8, description: '勝利点6', effects: [], expansion: 'Base', isBasicSupply: true },
  ...
  { id: 'cellar', name: 'セラー', types: ['Action'], cost: 2, description: '手札を入れ替える', effects: [], expansion: 'Base', isBasicSupply: false },
  { id: 'chapel', name: '礼拝堂', types: ['Action'], cost: 2, description: 'カードを最大4枚廃棄できる', effects: [], expansion: 'Base', isBasicSupply: false },
  { id: 'moat', name: '防波堤', types: ['Action', 'Reaction'], cost: 2, description: 'カードを2枚引く（反応あり）', effects: [], expansion: 'Base', isBasicSupply: false },
